...
import { cn } from "@/utils/utils"; // Assumes shadcn's utility for class merging
...
const ExampleUsage = () => {
  return (
    <div
      className="flex flex-col gap-6 p-8 bg-background border rounded-lg max-w-4xl mx-auto shadow-md">
